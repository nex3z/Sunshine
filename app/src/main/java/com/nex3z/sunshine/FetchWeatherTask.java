...
import com.nex3z.sunshine.data.WeatherContract;
import com.nex3z.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            /////TEST
            Cursor curAll = mContext.getContentResolver().query(WeatherEntry.CONTENT_URI,
                    null, null, null, sortOrder);
            Log.d(LOG_TAG, "curAll.getCount() = " + curAll.getCount());
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(API_KEY_PARAM, mContext.getString(R.string.api_key_owm))
                    .build();
